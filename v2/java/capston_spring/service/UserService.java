...
public class UserService {
    ...
    public UserResponseDto getUserDetails(String username) {
        ...
        return new UserResponseDto(
                ...
                videoService.getVideosByMode(user.getId(), VideoMode.PRACTICE),
                videoService.getVideosByMode(user.getId(), VideoMode.CHALLENGE),
                accuracySessionService.getByUsername(username) // 정확도 세션도 username 기반으로!
        );
    }
