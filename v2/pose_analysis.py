...
# 기존 고정 크기 리사이즈 함수는 사용하지 않음 (주석 처리하거나 삭제해도 됨)
# def resize_frame_fixed_size(...):

def process_and_compare_videos(expert_video_path="videos1/vividiva.mp4", silhouette_path="video_uploads/contourwithaudio_x100.mp4"):
