...
public class PracticeSession {
    ...
    /** 초 단위 값을 LocalDateTime으로 변환하는 메서드 추가 **/
    ...
    /** LocalDateTime을 초 단위 값으로 변환하는 메서드 **/
    public int getStartTimeInSeconds() {
        return (int) (this.startTime.toEpochSecond(java.time.ZoneOffset.UTC) - LocalDateTime.of(1970, 1, 1, 0, 0).toEpochSecond(java.time.ZoneOffset.UTC));
    }

    public int getEndTimeInSeconds() {
        return (int) (this.endTime.toEpochSecond(java.time.ZoneOffset.UTC) - LocalDateTime.of(1970, 1, 1, 0, 0).toEpochSecond(java.time.ZoneOffset.UTC));
    }
}
